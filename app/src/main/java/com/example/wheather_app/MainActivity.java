...
public class MainActivity extends AppCompatActivity {
    ...
    private Button signButton, gotoRegisterPage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        responseRes = (TextView) findViewById(R.id.response_res);
        gotoRegisterPage = (Button) findViewById(R.id.misha);
    ...
    public void loginUser(final String email, final String password) {
        String registerApiUrl =
                "http://192.168.43.106:3000/api/login";
                ...
                new Response.Listener<String>()
                {
                    ...
                    public void onResponse(String response) {
                        if(response.equals("failed")) {
                            responseRes.setText("user not found. pls register");
                        }else {
